...
"[project]/frontend/hooks/useAdminCompanyProfileNav.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAdminCompanyProfileNav() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAdminCompanyProfileNav.useEffect": ()=>{
            let cancelled = false;
            ({
                "useAdminCompanyProfileNav.useEffect": async ()=>{
                    try {
...
_s(useAdminCompanyProfileNav, "bXBd/WbmO9A8Q7bxaOKZvuJyGc0=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useAdminCompanyProfileNav$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/hooks/useAdminCompanyProfileNav.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function AdminSidebar({ isOpen, onToggle, mobileOpen, onMobileToggle }) {
    ...
    const showCompanyProfileNav = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useAdminCompanyProfileNav$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdminCompanyProfileNav"])();
    const [contactNewCount, setContactNewCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminSidebar.useEffect": ()=>{
            ...
            let cancelled = false;
            const fetchNew = {
                "AdminSidebar.useEffect.fetchNew": async ()=>{
                    try {
            ...
            }["AdminSidebar.useEffect.fetchNew"];
            void fetchNew();
            const iv = window.setInterval({
                "AdminSidebar.useEffect.iv": ()=>void fetchNew()
            }["AdminSidebar.useEffect.iv"], 45_000);
            const onRefresh = {
                "AdminSidebar.useEffect.onRefresh": ()=>void fetchNew()
            }["AdminSidebar.useEffect.onRefresh"];
                                                        ...
                                                        children: group.items.map((item)=>{
                                                            ...
                                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    item.kind === 'page' && item.id === 'settingsCompany' && contactNewCount > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(AdminSidebar, "zv9YbvrA87PGW0FX5gR7Wbqr8YM=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useAdminCompanyProfileNav$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdminCompanyProfileNav"]
    ];
});
_c = AdminSidebar;
var _c;
...
function AdminHeader({ onMenuClick, mobileMenuOpen }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminHeader.useEffect": ()=>{
            ...
            let cancelled = false;
            const fetchNew = {
                "AdminHeader.useEffect.fetchNew": async ()=>{
                    try {
                        const res = await fetch('/api/admin/contact-submissions/new-count', {
                            credentials: 'include'
                        });
            ...
            }["AdminHeader.useEffect.fetchNew"];
            void fetchNew();
            const iv = window.setInterval({
                "AdminHeader.useEffect.iv": ()=>void fetchNew()
            }["AdminHeader.useEffect.iv"], 45_000);
            const onRefresh = {
                "AdminHeader.useEffect.onRefresh": ()=>void fetchNew()
            }["AdminHeader.useEffect.onRefresh"];
            window.addEventListener('vuleits-contact-new-count-refresh', onRefresh);
            return ({
                "AdminHeader.useEffect": ()=>{
                    cancelled = true;
...
_s(AdminHeader, "zzjTttUrNzPNg8yJQjm5re439q0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$components$2f$providers$2f$LocaleProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocale"],
...
//# sourceMappingURL=frontend_65d35f28._.js.map