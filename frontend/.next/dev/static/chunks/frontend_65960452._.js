...
"[project]/frontend/lib/locale/uiMessagesExcel.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildSaveEntries(draft, keys) {
    ...
    for (const key of keys){
        for (const loc of __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UI_LOCALES"]){
            ...
            const def = (__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultMessagesByLocale"][loc][key] ?? '').trim();
            if (current === def) {
                entries.push({
                    locale: loc,
                    key,
...
"[project]/frontend/components/admin/TranslationsAdminPanel.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/lib/locale/defaultMessages.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$uiMessagesExcel$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/lib/locale/uiMessagesExcel.ts [app-client] (ecmascript)");
;
...
function TranslationsAdminPanel() {
    _s();
    const { t, refreshUiMessages } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$components$2f$providers$2f$LocaleProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocale"])();
    ...
    const [sectionFilter, setSectionFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const importTargetRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const validKeySet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TranslationsAdminPanel.useMemo[validKeySet]": ()=>new Set(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["allUiMessageKeys"])
    }["TranslationsAdminPanel.useMemo[validKeySet]"], []);
    const sectionOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TranslationsAdminPanel.useMemo[sectionOptions]": ()=>{
            const counts = new Map();
            for (const k of __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["allUiMessageKeys"]){
                const s = keySection(k);
                counts.set(s, (counts.get(s) ?? 0) + 1);
            }
            const sections = Array.from(counts.keys()).sort({
                "TranslationsAdminPanel.useMemo[sectionOptions].sections": (a, b)=>a.localeCompare(b)
            }["TranslationsAdminPanel.useMemo[sectionOptions].sections"]);
            return {
                counts,
                sections
            };
    ...
    const load = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TranslationsAdminPanel.useCallback[load]": async ()=>{
            setLoading(true);
            try {
                const res = await fetch('/api/admin/ui-messages', {
                    credentials: 'include'
                ...
                const next = {};
                for (const key of __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["allUiMessageKeys"]){
                    next[key] = {
                        'en-US': data['en-US']?.[key] ?? __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultMessagesByLocale"]['en-US'][key] ?? '',
                        'vi-VN': data['vi-VN']?.[key] ?? __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultMessagesByLocale"]['vi-VN'][key] ?? ''
                    };
                }
                setDraft(next);
            } catch  {
    ...
    }["TranslationsAdminPanel.useCallback[load]"], [
        toast,
        t
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TranslationsAdminPanel.useEffect": ()=>{
            void load();
        }
    }["TranslationsAdminPanel.useEffect"], [
        load
    ]);
    const filteredKeys = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TranslationsAdminPanel.useMemo[filteredKeys]": ()=>{
            let keys = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["allUiMessageKeys"];
            if (sectionFilter) {
                keys = keys.filter({
                    "TranslationsAdminPanel.useMemo[filteredKeys]": (k)=>keySection(k) === sectionFilter
                }["TranslationsAdminPanel.useMemo[filteredKeys]"]);
            }
            if (statusFilter === 'custom') {
                keys = keys.filter({
                    "TranslationsAdminPanel.useMemo[filteredKeys]": (k)=>isKeyCustomized(draft, k)
                }["TranslationsAdminPanel.useMemo[filteredKeys]"]);
            ...
            if (qq) {
                keys = keys.filter({
                    "TranslationsAdminPanel.useMemo[filteredKeys]": (k)=>{
                        const row = draft[k];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TranslationsAdminPanel.useEffect": ()=>{
            setPage({
                "TranslationsAdminPanel.useEffect": (p)=>Math.min(p, pageCount)
            }["TranslationsAdminPanel.useEffect"]);
        }
    }["TranslationsAdminPanel.useEffect"], [
        pageCount
    ...
    const { displayedKeys, rangeFrom, rangeTo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TranslationsAdminPanel.useMemo": ()=>{
    ...
    const save = async ()=>{
        ...
        setSaving(true);
        try {
            const entries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$uiMessagesExcel$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildSaveEntries"])(draft, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["allUiMessageKeys"]);
    ...
    const exportExcel = async ()=>{
        try {
            ...
            const aoa = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$uiMessagesExcel$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["draftToAoA"])(draft, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["allUiMessageKeys"]);
    ...
    const runImportFromFile = async (file, target)=>{
        try {
            ...
            const { patch, unknownKeys, appliedRows } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$uiMessagesExcel$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseTranslationSheet"])(aoa, validKeySet);
            if (appliedRows === 0) {
            ...
            const merged = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$uiMessagesExcel$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeDraftWithPatch"])(draft, patch);
            setDraft(merged);
            if (unknownKeys.length > 0) {
                toast.info(t('admin.uiMessagesImportSkippedUnknown', {
                    count: String(unknownKeys.length)
            ...
            setSaving(true);
            try {
                const entries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$uiMessagesExcel$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildSaveEntries"])(merged, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["allUiMessageKeys"]);
                await putEntriesChunked(entries, SAVE_CHUNK);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                ...
                                                children: [
                                                    ...
                                                    " (",
                                                    __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$locale$2f$defaultMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["allUiMessageKeys"].length,
                                                    ")"
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/frontend/components/admin/TranslationsAdminPanel.tsx",
                                            ...
                                            sectionOptions.sections.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: s,
                                                    children: [
                                                        s,
                                                        " (",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        ...
                                        className: "px-3 py-2 rounded-lg bg-black/40 border border-white/15 text-white text-sm",
                                        children: [
                                            PAGE_SIZE_OPTIONS.map((n)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: String(n),
                                                    children: n
                                                }, n, false, {
                                                    fileName: "[project]/frontend/components/admin/TranslationsAdminPanel.tsx",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            pageSize !== 'all' && pageCount > 1 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            displayedKeys.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                lineNumber: 479,
                columnNumber: 9
            }, this) : view === 'table' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                            children: displayedKeys.map((key)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                ...
                children: displayedKeys.map((key)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TranslationsAdminPanel, "fc5DBMNoZhmcTBXhVd/7xn5opCM=", false, function() {
    return [
...
_c = TranslationsAdminPanel;
var _c;
__turbopack_context__.k.register(_c, "TranslationsAdminPanel");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/frontend/components/admin/TranslationsAdminPanel.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/frontend/components/admin/TranslationsAdminPanel.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=frontend_65960452._.js.map