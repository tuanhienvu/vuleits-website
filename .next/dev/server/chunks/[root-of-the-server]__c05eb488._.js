...
"[project]/WebPortal/vuleits-website/src/app/api/about/team/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
  ...
  `;
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(list.map((r)=>({
            id: Number(r.id),
            emoji: r.emoji,
            name: r.name,
            role: r.role,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c05eb488._.js.map