...
async function PUT(req, { params }) {
    ...
    if (willChangeRole) {
        const roleRow = await __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].role.findUnique({
            where: {
                id: user.roleId
            },
            select: {
        ...
        if (roleRow?.name) await (0, __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$src$2f$lib$2f$roleDefaultUserPermissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyRoleDefaultUserPermissions"])(user.id, roleRow.name);
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true,
        user: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96e05642._.js.map