...
"[project]/WebPortal/vuleits-website/src/app/api/admin/company-profile/logo/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const fsPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dir, safeName);
    await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["writeFile"])(fsPath, buf);
    const publicUrl = `/uploads/company/${safeName}`;
    const media = await __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].media.create({
        data: {
            filename: safeName,
            mimeType: file.type,
            size: buf.length,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__536dd035._.js.map