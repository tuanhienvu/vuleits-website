...
"[project]/WebPortal/vuleits-website/src/app/api/admin/services/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authorize"])(req, 'services.create');
    if (auth.error) return auth.error;
    ...
    if (body.features !== undefined && body.features !== null) {
        if (Array.isArray(body.features)) features = JSON.stringify(body.features.map((x)=>String(x)));
        else if (typeof body.features === 'string') features = body.features;
        else features = JSON.stringify(body.features);
    }
    if (!icon || !title || !description) return __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4f8b8d5b._.js.map