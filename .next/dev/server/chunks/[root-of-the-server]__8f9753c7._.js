...
"[project]/WebPortal/vuleits-website/src/app/api/admin/me-permissions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const features = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$src$2f$lib$2f$effectivePermissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getEffectiveFeatureMatrix"])(auth.user.id);
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
        where: {
            id: auth.user.id
        },
    ...
    if (user?.role && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$src$2f$lib$2f$adminUsersModule$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canAccessUsersModule"])(user.role.name)) {
        const none = {
            create: false,
            read: false,
            update: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f9753c7._.js.map