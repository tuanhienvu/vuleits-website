...
function isSocialPlatformId(s) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$src$2f$lib$2f$companyProfileTypes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SOCIAL_PLATFORM_IDS"].includes(s);
}
async function GET() {
    ...
    const socialLinks = profile.socialLinks.map((l)=>{
        const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$WebPortal$2f$vuleits$2d$website$2f$src$2f$lib$2f$publicHttpUrl$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanitizePublicHttpUrl"])(l.url);
        if (!url) return null;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__defb05c5._.js.map