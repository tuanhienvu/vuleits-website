...
"[project]/backend/src/lib/companyProfileTypes.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/backend/src/lib/companyProfileBranding.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileTypes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/companyProfileTypes.ts [app-route] (ecmascript)");
;
;
async function resolveCompanyLogoDisplayUrl(data) {
    if (data.logoMediaId != null) {
        const m = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].media.findUnique({
            where: {
                id: data.logoMediaId
            },
            select: {
...
async function getPublicCompanyBranding() {
    const row = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].siteSetting.findUnique({
        where: {
            key: __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileTypes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["COMPANY_PROFILE_SETTING_KEY"]
        }
    });
    const profile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileTypes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseCompanyProfileJson"])(row?.value ?? null);
...
"[project]/backend/src/lib/companyProfileAccess.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function requireCompanyProfileAdmin(request) {
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authorize"])(request);
    if ('error' in auth) return {
        error: auth.error
    };
    const row = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
        where: {
            id: auth.user.id
        },
        include: {
    ...
    const n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminRoleRank$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeRoleName"])(row?.role?.name);
...
"[project]/backend/src/lib/googleMapsEmbed.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/backend/app/api/admin/company-profile/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileBranding$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/companyProfileBranding.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileTypes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/companyProfileTypes.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileAccess$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/companyProfileAccess.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$googleMapsEmbed$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/googleMapsEmbed.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    const gate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileAccess$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireCompanyProfileAdmin"])(req);
    ...
    const profile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileTypes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseCompanyProfileJson"])(row?.value ?? null);
    const logoDisplayUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileBranding$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveCompanyLogoDisplayUrl"])(profile);
...
function bodyToProfile(body) {
    const base = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileTypes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["defaultCompanyProfile"])();
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileTypes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseCompanyProfileJson"])(JSON.stringify({
        ...merged,
...
async function PUT(req) {
    ...
    if (profile.mapEmbedUrl.trim() && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$googleMapsEmbed$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isAllowedGoogleMapsEmbedUrl"])(profile.mapEmbedUrl)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6efd062c._.js.map