...
"[project]/backend/src/lib/publicUploads.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function normalizeUploadSubfolder(input, fallback = 'general') {
...
async function savePublicUpload(params) {
    ...
    const filename = `${Date.now()}-${(0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomBytes"])(5).toString('hex')}.${ext}`;
    const root = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads');
    const dir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(root, ...folder.split('/'));
    ...
    const fsPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dir, filename);
    await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["writeFile"])(fsPath, params.buffer);
...
async function removePublicUploadFile(fsPath) {
    await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["unlink"])(fsPath).catch(()=>{});
}
}),
"[project]/backend/app/api/admin/media/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$publicUploads$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/publicUploads.ts [app-route] (ecmascript)");
;
;
;
;
async function GET(req) {
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authorize"])(req, 'media.read');
    ...
    const list = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].media.findMany({
        where: imagesOnly ? {
            mimeType: {
                startsWith: 'image/'
            }
...
async function POST(req) {
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authorize"])(req, 'media.create');
    if (auth.error) return auth.error;
    ...
    let saved;
    try {
        saved = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$publicUploads$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["savePublicUpload"])({
            subfolder,
            buffer: buf,
            mimeType: file.type
        });
    } catch (e) {
        if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$publicUploads$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PublicUploadError"]) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: e.message
            }, {
                status: e.statusCode
    ...
    try {
        const media = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].media.create({
            data: {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$publicUploads$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["removePublicUploadFile"])(saved.fsPath);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__27c6b4db._.js.map