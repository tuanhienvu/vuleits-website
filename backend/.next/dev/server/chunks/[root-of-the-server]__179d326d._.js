...
"[project]/backend/app/api/company/contact/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function isSocialPlatformId(s) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$companyProfileTypes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SOCIAL_PLATFORM_IDS"].includes(s);
}
async function GET() {
    ...
    const mapEmbedSrc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$googleMapsEmbed$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolvePublicMapEmbedSrc"])(profile.mapEmbedUrl, profile.address);
    const socialLinks = profile.socialLinks.map((l)=>{
        const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$publicHttpUrl$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanitizePublicHttpUrl"])(l.url);
        if (!url) return null;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__179d326d._.js.map