...
"[project]/backend/app/api/services/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function toCard(s) {
    return {
        ...
        icon: s.icon,
        title: s.title,
        description: (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$sanitizeAboutIntroHtml$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanitizeAboutIntroBodyHtml"])(s.description ?? ''),
        features: parseFeatures(s.features).map((x)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$sanitizeAboutIntroHtml$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanitizeAboutIntroBodyHtml"])(x)),
        order: s.order
    };
}
async function GET(req) {
    ...
    const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].serviceItem.findMany({
        where: {
            isActive: true
        },
        orderBy: [
    ...
    const filtered = q ? cards.filter((s)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2342123a._.js.map