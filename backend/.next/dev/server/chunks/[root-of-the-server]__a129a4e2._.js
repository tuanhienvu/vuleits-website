...
"[project]/backend/src/lib/news/newsCategories.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/backend/app/api/news/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$news$2f$newsCategories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/news/newsCategories.ts [app-route] (ecmascript)");
;
;
;
;
async function GET(req) {
    ...
    const allowedCats = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$news$2f$newsCategories$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NEWS_CATEGORIES"]);
    ...
    const now = new Date();
    const candidates = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].news.findMany({
        where: {
            status: 'Active'
        },
        orderBy: {
    ...
    const items = candidates.map((n)=>{
        ...
        const item = {
            ...
            contentPreviewHtml: (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$news$2f$sanitizeNewsContentHtml$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanitizeNewsContentHtml"])(n.content).slice(0, 2000)
        };
        return {
            item,
            effectiveDate,
            includeByPublishWindow
        };
    }).filter((x)=>x.includeByPublishWindow).filter((x)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a129a4e2._.js.map