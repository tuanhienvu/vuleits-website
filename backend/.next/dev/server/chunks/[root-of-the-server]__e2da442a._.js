...
"[project]/backend/app/api/admin/me/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req) {
    ...
    const displayName = body.displayName == null || body.displayName === '' ? null : String(body.displayName).trim().slice(0, 150) || null;
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.update({
        where: {
            id: auth.user.id
        },
        data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e2da442a._.js.map