...
"[project]/backend/src/lib/roleDefaultUserPermissions.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s([
    "applyRoleDefaultRolePermissions",
    ()=>applyRoleDefaultRolePermissions,
...
function getRoleDefaultMatrix(roleName) {
    const m = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminPermissionModel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeEmptyAdminMatrix"])();
    const R = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminRoleRank$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeRoleName"])(roleName);
    if (R === 'SYSADMIN' || R === 'ADMIN') {
        for (const f of __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminPermissionModel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UI_FEATURES"])m[f] = {
            ...ON
        };
        return m;
    }
...
async function applyRoleDefaultUserPermissions(userId, roleName) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].userPermission.deleteMany({
        where: {
            userId
        }
    });
    const permissionNames = [];
    for (const f of __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminPermissionModel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UI_FEATURES"]){
        const prefix = __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$effectivePermissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["featureToPermissionPrefix"][f];
        for (const a of __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$effectivePermissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PERMISSION_ACTIONS"]){
            permissionNames.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$effectivePermissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["buildPermissionName"])(prefix, a));
        }
    }
    const permissions = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].permission.findMany({
        where: {
    ...
    for (const f of __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminPermissionModel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UI_FEATURES"]){
        ...
        for (const a of __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$effectivePermissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PERMISSION_ACTIONS"]){
            if (!cell[a]) continue;
            const permissionId = nameToId.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$effectivePermissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["buildPermissionName"])(prefix, a));
    ...
    if (rows.length > 0) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].userPermission.createMany({
            data: rows
        });
    }
}
async function applyRoleDefaultRolePermissions(roleId, roleName) {
    const matrix = getRoleDefaultMatrix(roleName);
    await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].rolePermission.deleteMany({
        where: {
            roleId
        }
    });
    ...
    if (rows.length > 0) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].rolePermission.createMany({
            data: rows
        });
    }
}
}),
"[project]/backend/app/api/admin/users/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminRoleRank$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/adminRoleRank.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminEmail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/adminEmail.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$roleDefaultUserPermissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/roleDefaultUserPermissions.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authorize"])(req, 'users.read');
    if (auth.error) return auth.error;
    const gate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminUsersModule$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["enforceUsersModuleAccess"])(auth.user.id);
    if (gate) return gate;
    const list = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findMany({
        select: {
            id: true,
            email: true,
            displayName: true,
...
async function POST(req) {
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authorize"])(req, 'users.create');
    if (auth.error) return auth.error;
    const gate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminUsersModule$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["enforceUsersModuleAccess"])(auth.user.id);
    if (gate) return gate;
    const operator = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
        where: {
            id: auth.user.id
        },
        include: {
    ...
    if (!operator?.role) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Forbidden'
    }, {
        status: 403
    });
    ...
    const email = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminEmail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeAdminEmail"])(rawEmail);
    const passwordStr = password == null ? '' : String(password);
    if (!email || !passwordStr) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Missing fields'
    }, {
        status: 400
    });
    const exists = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
        where: {
            email
        }
    });
    ...
    const defaultAdmin = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].role.findUnique({
        where: {
            name: 'ADMIN'
        },
        select: {
    ...
    if (!defaultAdmin) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const newRole = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].role.findUnique({
        where: {
            id: roleId
        },
        select: {
    ...
    if (!newRole) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Invalid role'
    }, {
        status: 400
    });
    const opRank = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminRoleRank$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoleRank"])(operator.role.name);
    const newRank = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminRoleRank$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoleRank"])(newRole.name);
    if (newRank < opRank) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminRoleRank$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeRoleName"])(newRole.name) === 'SYSADMIN' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminRoleRank$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeRoleName"])(operator.role.name) !== 'SYSADMIN') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const hash = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(passwordStr, 10);
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.create({
        data: {
            email,
            displayName,
            password: hash,
    ...
    // UserPermission rows for the chosen role.
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$roleDefaultUserPermissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyRoleDefaultUserPermissions"])(user.id, newRole.name);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true,
        user: {
            id: user.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb0b9de2._.js.map