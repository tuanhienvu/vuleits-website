...
async function GET() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((Array.isArray(list) ? list : []).map((item)=>({
            ...item,
            description: (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$sanitizeAboutIntroHtml$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanitizeAboutIntroBodyHtml"])(item.description ?? '')
        })));
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__624c516b._.js.map