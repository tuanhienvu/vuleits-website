...
"[project]/backend/app/api/about/stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
  ...
  `;
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(list.map((r)=>({
            id: Number(r.id),
            number: r.number,
            label: r.label
        })));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03a729ac._.js.map