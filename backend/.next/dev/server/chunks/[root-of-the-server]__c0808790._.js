...
"[project]/backend/src/lib/jsonBody.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/** Narrow JSON to a string-keyed object for safe field reads (avoids `any`). */ __turbopack_context__.s([
    "jsonObjectBody",
    ()=>jsonObjectBody,
    "readNestedBoolean",
    ()=>readNestedBoolean
...
function readNestedBoolean(root, featureKey, actionKey) {
...
"[project]/backend/app/api/admin/services/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$jsonBody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/jsonBody.ts [app-route] (ecmascript)");
;
;
;
;
async function GET(req) {
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authorize"])(req, 'services.read');
    if (auth.error) return auth.error;
    const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$queryRaw`
    SELECT id, icon, title, description, features, \`order\` as \`order\`, isActive
    FROM ServiceItem
    ORDER BY \`order\` ASC, id ASC
  `;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(rows.map((r)=>({
            id: Number(r.id),
            icon: r.icon,
            title: r.title,
...
async function POST(req) {
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authorize"])(req, 'services.create');
    if (auth.error) return auth.error;
    const body = (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$jsonBody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonObjectBody"])(await req.json());
    ...
    if (!icon || !title || !description) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Missing fields'
    }, {
        status: 400
    });
    if (!Number.isFinite(order)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Invalid order'
    }, {
        status: 400
    });
    await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$executeRaw`
  ...
  `;
    const created = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$queryRaw`
    SELECT id, icon, title, description, features, \`order\` as \`order\`, isActive
    FROM ServiceItem
    ORDER BY id DESC
    LIMIT 1
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c0808790._.js.map